  ...
  <div>
    ...
    <div class="flex p-2 pl-14">
      <div class="flex w-full text-white">
        <!-- Image frame Icon -->
        <div
          class="p-2 text-blue-400 rounded-full hover:bg-blue-50 hover:cursor-pointer dark:hover:bg-dim-800"
      ...
      <div class="ml-auto">
        <UIButton @onClick="handleFormSubmit" :disabled="isDisabled" size="md" @click="handleFormSubmit">
          <strong>
            Tweet
          </strong>
        </UIButton>
